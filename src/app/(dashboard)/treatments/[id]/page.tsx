...
import { App, Button, Card, DatePicker, Descriptions, Flex, Form, Input, Select, Space, Tag, Typography } from "antd";
      ...
      <Card title="Histórico de aplicações" loading={isLoading}>
        {data?.logs && data.logs.length > 0 ? (
          <Flex vertical gap="middle">
            {(data.logs as TreatmentLog[]).map((item) => (
              <Flex key={item.id} vertical style={{ padding: "12px 0", borderBottom: "1px solid #f0f0f0" }}>
                <Space>
