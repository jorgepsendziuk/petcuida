...
import { App, Button, Card, DatePicker, Divider, Form, Input, InputNumber, Select, Space, Typography } from "antd";
...
export default function TreatmentCreatePage() {
  ...
  const handlePrescriptionSuccess = (prescriptionId: string) => {
    message.success("Receita processada e tratamentos criados com sucesso!");
    router.push("/treatments");
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Opção de upload de receita com OCR */}
        {selectedPetId && (
          <>
            <Divider>
              <Title level={5} style={{ margin: 0 }}>
                Ou envie uma receita médica
              </Title>
            </Divider>
